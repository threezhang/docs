...
description: "Nano Banana Pro Text-to-Image API: Google Gemini 3 Pro image generation. Supports 4K HD, complex instruction understanding, thinking mode. Now $0.09/image, 62.5% cheaper than official pricing."
icon: "cherry"
---
...
- **Best Value**: Only **$0.09/image** (62.5% cheaper than official $0.24)
</Note>

<CardGroup cols={2}>
  <Card title="🎁 Free Trial" icon="gift" href="https://api.laozhang.ai">
    Register and get **$0.05** credit toward Nano Banana Pro usage
  </Card>
...
- **💰 Great Value**: $0.09/image (62.5% cheaper than official $0.24)
...
| **Nano Banana2** | `gemini-3.1-flash-image-preview` | Per-use | $0.081/image | - | - | 1K/2K/4K | ~10s |
...
- **Nano Banana Pro**: $0.09/image (LaoZhang API) vs $0.24/image (official), 62.5% cheaper
...
<AccordionGroup>
  <Accordion title="How to test Nano Banana Pro API for free?">
    ...
    $0.05 can be applied toward your first Nano Banana Pro request.
  </Accordion>
  ...
  <Accordion title="What is the Nano Banana Pro API price?">
    ...
    Register to get $0.05 credit toward usage.
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Nano Banana2 Image Generation" icon="citrus" href="/en/api-capabilities/nano-banana2-image">
    $0.081/image, better value Banana2 version
  </Card>
