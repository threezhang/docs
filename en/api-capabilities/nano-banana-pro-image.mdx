...
<AccordionGroup>
  <Accordion title="How to test Nano Banana Pro API for free?">
    ...
    2. Automatically receive **$0.5 free credit**
    3. Create token and select "Pay-per-use"
    4. Call the `gemini-3-pro-image-preview` model

    $0.5 can be applied toward multiple Nano Banana Pro requests.
  </Accordion>
  ...
  <Accordion title="What is the Nano Banana Pro API price?">
    ...
    Register to get $0.5 credit toward usage.
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Nano Banana2 Image Generation" icon="citrus" href="/en/api-capabilities/nano-banana2-image">
    $0.055/image, better value Banana2 version
  </Card>
