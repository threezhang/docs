...
description: "Nano Banana2 Image Generation API: Powered by Gemini 3.1 Flash. Only $0.045/image, supports text-to-image + image editing, 4K resolution, compatible with OpenAI SDK and Google native format."
icon: "citrus"
---
...
| **Nano Banana2** | `gemini-3.1-flash-image-preview` | Per-use | \$0.045/image | 1K/2K/4K | ~10s | Best value, high quality |
...
- **Best value for advanced use**: Choose **Nano Banana2** (\$0.045/image)
