...
description: "Nano Banana2 Image Generation API: Powered by Gemini 3.1 Flash. Only $0.081/image, supports text-to-image + image editing, 4K resolution, compatible with OpenAI SDK and Google native format."
icon: "citrus"
---
...
- **Great Value**: Only **\$0.081/image**, cheaper than Pro
...
<CardGroup cols={2}>
  <Card title="🎁 Free Trial" icon="gift" href="https://api.laozhang.ai">
    Register and get **$0.05** credit toward Nano Banana2 usage
  </Card>
...
<Steps>
  ...
  <Step title="Configure Billing Mode">
    ...
    <Note>
    Both modes have **identical pricing** at $0.081/image, only the billing method differs.
    </Note>
...
| **Nano Banana2** | `gemini-3.1-flash-image-preview` | Per-use | \$0.081/image | 1K/2K/4K | ~10s | Best value, high quality |
...
- **Best value for advanced use**: Choose **Nano Banana2** (\$0.081/image)
