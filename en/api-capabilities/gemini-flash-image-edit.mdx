...
- 💰 **Pricing**: Nano Banana \$0.025/edit (37.5% off), Nano Banana 2 \$0.09/edit (62.5% off official \$0.24)
</Note>
...
- **Price**: \$0.09/edit (62.5% cheaper than official \$0.24)
...
- 💰 Great value: Nano Banana \$0.025/edit (37.5% off), Nano Banana 2 \$0.09/edit (62.5% off)
</Note>
...
|-------|-----------|----------|---------|-----------|------------|-------|----------------------|
| **Nano Banana 2** | 🆕 Latest | `gemini-3-pro-image-preview` | Preview | Gemini 3 | 1K/2K/4K | \$0.09/edit | Best quality, high resolution needed |
...
|-------|----------|---------|---------------|----------------|---------|------------|-------|
| **Nano Banana 2** | `gemini-3-pro-image-preview` | Per Request | \$0.09/edit | \$0.24/edit | 62.5% | 1K/2K/4K | ~10s |
...
<Tip>
💰 **Pricing Advantage**  
- **Nano Banana 2**: \$0.09/edit (LaoZhang API) vs \$0.24/edit (Official), 62.5% cheaper
...
<Accordion title="Example 1: Single Image Edit → Add Elements to Generate First Image">
...
<Accordion title="Example 2: Style Transfer → Use First Image to Generate Second Image">
...
<Accordion title="Example 3: Multi-Image Fusion → Combine First and Second Images to Generate Third">
...
|-------|--------------|----------|---------|
| **Nano Banana 2** | \$0.09/edit | \$0.24/edit | **62.5%** |
...
- 💰 Updated pricing: Nano Banana 2 \$0.09/edit (62.5% off official \$0.24)
