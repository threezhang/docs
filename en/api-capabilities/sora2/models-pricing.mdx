...
| Portrait/Landscape - 15s | 15s | $0.25/call | ≈ ¥1.7/call |
...
<Steps>
  <Step title="Determine Duration">
    ...
    - Full narratives, more details → Choose 15s version ($0.25/call)
  </Step>
...
<AccordionGroup>
  <Accordion title="Why is there no HD version?" icon="circle-question">
    Due to official OpenAI computing power limitations, -hd (high definition) versions are temporarily unavailable and will be relaunched when resources become sufficient.
    
    The four currently available models (10s and 15s, portrait and landscape) all have extremely high stability and can meet most use cases.
  </Accordion>
