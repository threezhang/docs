...
description: "Sora 2 API access: OpenAI's official video generation model. Text-to-video and image-to-video supported. No watermark, 1080P HD, $0.15/video. Affordable alternative to official pricing."
icon: "clapperboard"
---
...
<Tip>
**Need ultimate stability?** If the current solution doesn't meet your stability requirements, try the [Official Forward Plan](/en/api-capabilities/sora2/official-forward) (OpenAI official API transparent forwarding, 99.99% availability).
</Tip>
