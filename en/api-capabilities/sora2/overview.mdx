...
- **10/10** Added sora-2-pro-all HD model, supports HD 1080P and 15-second duration
...
Due to official OpenAI's computing power limitations, -hd (high definition) versions are temporarily unavailable and will be re-launched once resources are sufficient.
</Note>
...
| `sora-2-pro-all` | 1024×1792 | 15s | $0.4/video | ⭐⭐⭐ Fair |
