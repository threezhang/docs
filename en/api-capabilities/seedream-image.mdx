...
<CardGroup cols={2}>
  <Card title="Nano Banana Image Generation" icon="sparkles" href="/api-capabilities/nano-banana-image">
    Also $0.025/image Gemini image generation
  </Card>
  <Card title="FLUX Image Generation" icon="bolt" href="/api-capabilities/flux-image-generation">
