---
title: "SeeDream Image Generation/Editing"
description: "SeeDream API: BytePlus Ark image model. Supports 4.0 ($0.035/image) and 4.5 ($0.045/image) versions, text-to-image and image-to-image, up to 10 reference images."
icon: "palette"
---
