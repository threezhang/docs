...
description: $0.05/image (79% off), free trial credit, 10s generation, unlimited concurrency
"og:description": Nano Banana 2 API (gemini-3-pro-image-preview) at $0.05/image - 79% cheaper than official $0.24. Free $0.05 trial credit on signup. 4K resolution, 10-second generation.
icon: "sparkles"
---
...
<CardGroup cols={2}>
  <Card title="🎁 Free Trial" icon="gift" href="https://api.laozhang.ai">
    Get **$0.05** free credit, test Nano Banana 2 once
  </Card>
  <Card title="🚀 Online Test" icon="play" href="https://images.laozhang.ai/">
...
$0.05 credit = 1 free Nano Banana 2 test!

### What is the Nano Banana 2 API price?

| Provider | Price | Note |
|----------|-------|------|
| **LaoZhang API** | **$0.05/image** | 79% off |
| Google Official | $0.24/image | Original |

Sign up for $0.05 free credit to test once!
