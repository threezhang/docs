...
"og:description": Nano Banana 2 API (gemini-3-pro-image-preview) at $0.09/image - 62.5% cheaper than official $0.24. Includes $0.5 signup credit. 4K resolution, 10-second generation.
icon: "sparkles"
---
...
<CardGroup cols={2}>
  <Card title="🎁 Free Trial" icon="gift" href="https://api.laozhang.ai">
    Get **$0.5** signup credit toward Nano Banana 2 usage
  </Card>
...
2. Get **$0.5 free credit** automatically on signup
3. Create API token with "pay-per-call" billing mode
4. Call `gemini-3-pro-image-preview` model

$0.5 signup credit can be applied toward multiple Nano Banana 2 requests.
...
Sign up for $0.5 credit toward usage.
