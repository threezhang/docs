---
title: "Quick Start"
description: "Quickly get started with VEO video generation API"
icon: "rocket"
---

<Warning>
  Before starting, please register for LaoZhang API and get your API key at https://api.laozhang.ai/token (copy token)
</Warning>
