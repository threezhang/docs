---
title: "Models and Pricing (Custom API - Deprecated)"
description: "List of models and pricing information supported by VEO API - Legacy documentation"
...
Please see new version: [Veo-3.1 Overview](/en/api-capabilities/veo/veo-31-overview) with lower prices ($0.15-$0.25/request)
</Warning>
