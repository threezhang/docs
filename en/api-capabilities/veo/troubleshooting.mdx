---
title: "Error Handling (Custom API - Deprecated)"
description: "VEO API error handling, limitation explanations, and common issue resolution - Legacy documentation"
...
Please see new version: [Veo-3.1 Troubleshooting](/en/api-capabilities/veo/veo-31-troubleshooting)
</Warning>
...
<Accordion>
  ...
  <AccordionItem title="How to get more quota?">
    Please contact threezhang.cn@gmail.com or WeChat laozhangdaichong to request quota increase.
  </AccordionItem>
</Accordion>
