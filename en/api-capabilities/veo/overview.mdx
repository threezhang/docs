...
<Card title="Get API Key" icon="key" href="mailto:feedback@laozhang.ai">
  Contact **feedback@laozhang.ai** or WeChat **laozhangdaichong** to get API key
</Card>

## Related Links

<CardGroup cols={2}>
  <Card title="Quick Start" icon="rocket" href="/api-capabilities/veo/quick-start">
    Learn how to get started quickly
  </Card>
  <Card title="API Reference" icon="book" href="/api-capabilities/veo/api-reference">
    View detailed API documentation
  </Card>
  <Card title="Code Examples" icon="code" href="/api-capabilities/veo/examples">
    View examples in various programming languages
  </Card>
  <Card title="Best Practices" icon="lightbulb" href="/api-capabilities/veo/best-practices">
