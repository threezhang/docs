...
description: "Nano Banana Pro Image Editing API: Professional image editing powered by Gemini 3 Pro. $0.09/edit, supports 4K output, complex instructions, multi-image fusion (up to 14 images)."
icon: "paintbrush"
---

<Note>
**🧠 Intelligent Editing at New Heights**
...
- **💰 Great Value**: $0.09/edit (62.5% cheaper than official $0.24)
...
|-------|----------|---------|----------------|----------------|---------|------------|-------|
| **Nano Banana Pro** | `gemini-3-pro-image-preview` | Per-use | $0.09/edit | $0.24/edit | 62.5% | 1K/2K/4K | ~10s |
| **Nano Banana2** | `gemini-3.1-flash-image-preview` | Per-use | $0.081/edit | - | - | 1K/2K/4K | ~10s |
...
| **Price** | $0.09/edit | $0.081/edit | $0.025/edit |
...
<Tip>
💰 **Price Advantage**
- **Nano Banana Pro**: $0.09/edit (LaoZhang API) vs $0.24/edit (official), 62.5% cheaper
...
<AccordionGroup>
  ...
  <Accordion title="Why is Pro so affordable at LaoZhang API?">
    ...
    |-------|-------------|----------|---------|
    | **Nano Banana Pro** | $0.09/edit | $0.24/edit | **62.5%** |
