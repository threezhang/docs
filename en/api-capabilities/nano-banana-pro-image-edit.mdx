...
- **💰 Great Value**: $0.05/edit (79% cheaper than official $0.24)
...
<Tip>
💡 All three methods work the same. Choose whichever you prefer. Header methods are more secure (key won't appear in logs).
</Tip>
