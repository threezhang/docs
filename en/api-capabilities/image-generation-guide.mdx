...
<CardGroup cols={2}>
  ...
  <Card title="OpenAI-Compatible" icon="plug">
    **GPT-Image-2** - $0.03/call
    - OpenAI-compatible endpoints
    - Supports Chat Completions and Images API
    - Covers generation and editing

    [View Docs →](/en/api-capabilities/gpt-image-2)
  </Card>
  ...
  <Card title="Editing Features" icon="paintbrush">
    **GPT-Image-2 / Gemini Flash Edit**
    - GPT-Image-2 fits OpenAI-compatible image editing
    - Gemini Flash is useful for multi-image composition
    - Choose URL or Base64 based on your app

    [View GPT-Image-2 →](/en/api-capabilities/gpt-image-2)
  </Card>
</CardGroup>
...
| **GPT-Image-2** | $0.03/call | Medium | ⭐⭐⭐⭐⭐ | Chat Completions + Images API, URL/Base64 | OpenAI-compatible integration, generation and editing |
...
| OpenAI-compatible image-to-image | GPT-Image-2 | $0.03/call | Chat Completions supports URL/base64 input; Images Edits supports multipart |
...
<CardGroup cols={2}>
  ...
  <Card title="GPT-Image-2" icon="image" href="/en/api-capabilities/gpt-image-2">
    $0.03/call - OpenAI-compatible generation and editing
  </Card>
...
<Accordion title="Which should I choose? Quick Q&A">
  ...
  **Q: I want one OpenAI-compatible path for both generation and editing**
  A: Choose **GPT-Image-2**

  **Q: I need Base64 for direct web embedding**
  A: Choose **GPT-Image-2 Images API**, **Nano Banana**, or **Gemini Flash**
</Accordion>

<Tip>
Want to see actual results? Visit [yingtu.ai](https://yingtu.ai) to test different image models online.
</Tip>
