---
title: Open WebUI Domestic ChatGPT Deployment Configuration Guide
description: Open WebUI platform domestic self-hosted AI platform configuration tutorial, supporting direct access to ChatGPT, Claude and other models in China without circumvention
icon: "globe"
---
