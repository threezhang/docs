---
title: Cherry Studio AI Chat Client Configuration Guide
description: Cherry Studio tutorial for configuring LaoZhang API to use GPT, Claude, Gemini and 200+ AI models
