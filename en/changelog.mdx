...
description: "Latest AI model releases: GPT-Image-2, Claude Opus 4.7, GPT-5.2, Gemini 3 available on day one. Price updates, feature releases, and special offers. Subscribe for AI model news."
icon: "newspaper"
---

## 📅 April 2026

### 🎨 GPT-Image-2 Reverse Routes Updated; sora_image Official Route Offline
**April 22, 2026**
...
<Card>
  **Image generation route update**
  ...
  - 🚀 **New routes**:
    - `gpt-image-2` reverse ChatGPT Web route is now available for text-to-image and image-to-image workflows
    - `gpt-image-2-vip` reverse Codex route is now available with common `size` support; treat the two 4K sizes, `3840x2160` and `2160x3840`, as unsupported
  ...
  <Info>
    Default-group reverse routes support Chat Completions, Images Generations, and Images Edits. Use `gpt-image-2` for standard generation, use `gpt-image-2-vip` when you need common `size` values, and use `gpt-image-2` under the `Sora2Official` group when you need 4K or full official size support.
  </Info>
</Card>
...
- 🎨 Image API update: `gpt-image-2` and `gpt-image-2-vip` reverse routes are now available; `sora_image` official route is offline
...
- April 2026: GPT-Image-2 reverse routes launched with the new `gpt-image-2-vip` common-size route; `sora_image` official route went offline; Claude Opus 4.7 / Thinking launched; Nano Banana series pricing updated
