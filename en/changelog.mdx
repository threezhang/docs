...
### 🎨 GPT-Image-2 Reverse Route Now Available; sora_image Official Route Offline
**April 22, 2026**

<Card>
  **Image generation route update**

  - 🚀 **New route**: `gpt-image-2` reverse route is now available for text-to-image and image-to-image workflows

  - ⚠️ **Route change**:
    - The `sora_image` official route is now offline
    - New image generation integrations should use `gpt-image-2` first
  ...
  <Info>
    We recommend migrating new image generation workflows to `gpt-image-2`. For simple prompt-to-image-URL workflows, use Chat Completions; for standard Images API response shapes, use Images Generations or Images Edits.
  </Info>
</Card>
...
- 🎨 Image API update: GPT-Image-2 reverse route is now available; `sora_image` official route is offline
...
- April 2026: GPT-Image-2 reverse route launched; `sora_image` official route went offline; Claude Opus 4.7 / Thinking launched; Nano Banana series pricing updated
