---
title: Cline国内ChatGPT编程助手配置指南
sidebarTitle: Cline
description: Cline插件国内直连配置ChatGPT、Claude等AI编程助手教程，VS Code无需VPN使用
icon: "code"
---

## 插件简介

Cline（原 Claude Dev）是一款强大的 VS Code AI 编程助手插件，支持多种 AI 模型。通过 老张API，您可以灵活切换使用各种主流 AI 模型辅助编程。
