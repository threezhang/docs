...
<img src="/images/chatbox-setting.png" alt="Chatbox AI 设置界面 - API易配置示例" />
...
Chatbox AI 通过 API易 支持多种主流 AI 模型，包括：
...
<Info>
**查看完整模型列表**
详细的模型信息、定价和功能对比，请访问 [模型信息页面](https://docs.apiyi.com/api-capabilities/model-info)
</Info>
