---
title: Open WebUI国内ChatGPT部署配置指南
description: Open WebUI国内自托管AI平台配置教程，支持国内直连ChatGPT、Claude等模型，无需翻墙
icon: "globe"
---
...
- API Key 可在 [老张API控制台](https://api.laozhang.ai) 获取
- 建议使用环境变量方式，便于管理和更新
</Info>
...
需要更多帮助？请查看 [Open WebUI 官方文档](https://docs.openwebui.com) 或访问 [老张API官网](https://api.laozhang.ai)。