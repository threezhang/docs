---
title: LangChain国内ChatGPT开发框架配置指南
description: LangChain国内集成ChatGPT、Claude等AI模型开发教程，支持国内直连，无需翻墙开发AI应用
icon: "link"
---

## 框架简介

LangChain 是一个强大的框架，用于开发基于语言模型的应用程序。通过 老张API，您可以在 LangChain 中使用各种主流 AI 模型。
...
# 设置环境变量
os.environ["OPENAI_API_KEY"] = "您的老张API密钥"
