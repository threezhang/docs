"""
Gemini 音频理解 API 示例 - Google 原生格式 (Example)
...
if __name__ == "__main__":
    ...
    使用方法:
        ...
        2. 运行: python gemini_audio_native_example.py
        3. 或者: python gemini_audio_native_example.py /path/to/audio.mp3
    """
    print("=" * 60)
    print("Gemini 音频理解示例（Google 原生格式）")
    print("=" * 60)
