---
title: 价格说明
description: 了解 老张API 和 AI大模型的定价逻辑和优势，享受比官方更优惠的价格。用户提供透明、优惠的定价方案，让您以更低的成本享受顶级 AI 模型服务。
...
<CardGroup cols={2}>
  <Card title="优惠汇率" icon="dollar-sign">
    **1:7** 优惠汇率
...
<CardGroup cols={2}>
  ...
  <Card title="模型齐全" icon="layer-group">
    - 200+ 热门模型
    - 一键切换
    - 持续更新
  </Card>
...
<Info>
  查看完整的模型价格表：[APIYI 价格列表](https://api.laozhang.ai/account/pricing)
</Info>
...
<Tabs>
  <Tab title="海外模型">
    | 模型 | 官方输入价格 | 官方输出价格 | APIYI 输入价格 | APIYI 输出价格 |
    |------|-------------|-------------|---------------|---------------|
  ...
  <Tab title="国内模型">
    | 模型 | 官方输入价格 | 官方输出价格 | APIYI 输入价格 | APIYI 输出价格 | 优惠幅度 |
    |------|-------------|-------------|---------------|---------------|---------|
...
<AccordionGroup>
  <Accordion title="如何查看实时价格？">
    登录 [APIYI 控制台](https://api.laozhang.ai)，在模型列表页面可以查看所有模型的实时价格。
  </Accordion>
