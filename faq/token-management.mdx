---
title: "ChatGPT API密钥获取方法（国内版）"
description: "详细说明如何获取和管理老张API密钥，在国内使用ChatGPT、Claude等AI模型"
icon: "key"
---

## 获取ChatGPT使用密钥（默认令牌）

1. 进入顶部导航的"令牌"页面：[https://api.laozhang.ai/token](https://api.laozhang.ai/token)
