...
class APIYiClient:
    def __init__(self):
        self.client = OpenAI(
            ...
            base_url=os.getenv("APIYI_BASE_URL", "https://api.laozhang.ai/v1")
        )
...
需要更多帮助？请访问 [老张API官网](https://vip.laozhang.ai) 或查看 [官方 SDK 文档](https://platform.openai.com/docs/libraries)。