...
老张API 提供强大的图像理解能力，支持使用多种先进的 AI 模型对图像进行深度分析和理解。通过统一的 OpenAI API 格式，您可以轻松实现图像识别、场景描述、OCR 文字识别等功能。
...
- [完整代码示例](https://github.com/laozhang-api/ai-api-code-samples/tree/main/Vision-API-OpenAI)
