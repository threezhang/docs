...
description: "Sora 图像生成 API：基于 OpenAI Sora 技术，仅 $0.01/张超低价格。支持 2:3、3:2、1:1 多比例，URL 返回。"
icon: "wand-sparkles"
---
...
- [在线测试工具](https://imagen.laozhang.ai) - 比较不同模型效果
