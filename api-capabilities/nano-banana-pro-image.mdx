...
description: "Nano Banana Pro 文生图 API：Google Gemini 3 Pro 图像生成。支持 4K 高清、复杂指令理解、思考模式。仅 $0.05/张，官方 2 折。"
icon: "cherry"
---
...
| **Nano Banana2** | `gemini-3.1-flash-image-preview` | 按次计费 | \$0.045/张 | - | - | 1K/2K/4K | ~10秒 |
