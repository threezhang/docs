...
<CardGroup cols={2}>
  <Card title="🎁 免费测试" icon="gift" href="https://api.laozhang.ai">
    注册送 **$0.05**，可直接抵扣 Nano Banana Pro 调用费用
  </Card>
...
| **Nano Banana2** | `gemini-3.1-flash-image-preview` | 按次计费 | \$0.081/张 | - | - | 1K/2K/4K | ~10秒 |
...
<AccordionGroup>
  <Accordion title="Nano Banana Pro API 如何免费测试？">
    ...
    $0.05 可直接抵扣首笔 Nano Banana Pro 调用费用。
  </Accordion>
