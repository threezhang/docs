---
title: "SeeDream 图片生成/编辑"
description: "SeeDream API：字节跳动火山方舟图像模型。支持 4.0 ($0.035/张) 和 4.5 ($0.045/张) 版本，文生图和图改图，最多 10 张参考图。"
icon: "palette"
---
...
**可用模型：**
- `seedream-4-0-250828` - $0.035/图
- `seedream-4-5-251128` - $0.045/图（最新版本）
...
官方补贴已结束，SeeDream 价格已调整：
- SeeDream 4.0：$0.025/图 → **$0.035/图**
- SeeDream 4.5（新版本）：**$0.045/图**
</Warning>
...
<Steps>
  ...
  <Step title="配置计费模式">
    ...
    <Note>
    两种模式**价格完全相同**，仅扣费方式不同。SeeDream 4.0 为 \$0.035/张，4.5 为 \$0.045/张。
    </Note>
...
<CardGroup cols={2}>
  ...
  <Card title="灵活版本" icon="tag">
    4.0 版 $0.035/图，4.5 版 $0.045/图
  </Card>
</CardGroup>
...
| **模型名称** | `seedream-4-0-250828` / `seedream-4-5-251128` |
| **最大参考图** | 10 张 |
| **尺寸支持** | 可自定义分辨率 |
| **水印** | 可选关闭 |
...
| 版本 | 模型ID | 价格 | 说明 |
|------|--------|------|------|
| **SeeDream 4.0** | `seedream-4-0-250828` | $0.035/图 | 稳定版本 |
| **SeeDream 4.5** | `seedream-4-5-251128` | $0.045/图 | 最新版本，生成质量更高 |

<Note>
💰 **定价说明**

- **SeeDream 4.0**：$0.035/图（约 **0.25 元/图**）
- **SeeDream 4.5**：$0.045/图（约 **0.32 元/图**）
- **充值优惠**：单次大额充值加赠 10%
</Note>
