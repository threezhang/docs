---
title: "快速开始（自定义 API - 已过时）"
description: "快速上手使用 VEO 视频生成 API - 旧版文档"
icon: "rocket"
---
...
请查看新版文档: [Veo-3.1 快速开始](/api-capabilities/veo/veo-31-quick-start)

新版 API 使用 OpenAI 兼容格式，价格更低，功能更丰富。
</Warning>
