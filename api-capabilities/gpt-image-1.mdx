...
description: "GPT-4o 图像生成 API：OpenAI 官方 Image API 格式，支持多尺寸和质量等级。按 Token 计费，国内直连，完全兼容 OpenAI 格式。"
icon: "palette"
---
...
- [老张API控制台](https://api.laozhang.ai)
- [技术支持](mailto:support@laozhang.ai)
