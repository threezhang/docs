...
description: "Nano Banana Pro 图改图 API：基于 Gemini 3 Pro 的专业图像编辑。$0.05/次，支持 4K 输出、复杂指令、多图融合（最多 14 张）。"
icon: "paintbrush"
---
...
|------|---------|---------|---------|---------|------|--------|------|
| **Nano Banana Pro** | `gemini-3-pro-image-preview` | 按次 | \$0.05/次 | \$0.24/次 | 79% | 1K/2K/4K | ~10秒 |
| **Nano Banana2** | `gemini-3.1-flash-image-preview` | 按次 | \$0.045/次 | - | - | 1K/2K/4K | ~10秒 |
...
<AccordionGroup>
  ...
  <Accordion title="为什么 Pro 版在老张 API 这么便宜？">
    | 模型 | 老张 API | 官网 | 节省 |
    |------|---------|------|------|
    | **Nano Banana Pro** | \$0.05/次 | \$0.24/次 | **79%** |
