...
**带水印端点：** `https://api.laozhang.ai/v1/chat/completions?watermark=true`
...
默认生成的视频**无水印**。如需生成带 Sora 原生水印的视频，请在 URL 添加参数 `?watermark=true`。
</Note>
...
15秒模型已降价至 $0.15/次，与10秒模型同价！新增高清模型 sora-2-pro-all（$0.4/次）。
</Note>
