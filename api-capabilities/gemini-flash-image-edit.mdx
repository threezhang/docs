...
### Q1: Nano Banana 和 Nano Banana 2 有什么区别？

| 特性 | Nano Banana | Nano Banana 2 |
|------|-------------|---------------|
| **模型 ID** | `gemini-2.5-flash-image` | `gemini-3-pro-image-preview` |
| **版本** | Stable | Preview |
| **技术基础** | Gemini 2.5 | Gemini 3 |
| **分辨率** | 固定 1K（1024px） | 1K/2K/4K |
| **价格** | $0.025/次 | $0.05/次 |
| **Thinking Mode** | ❌ 无 | ✅ 有（内置推理） |
| **Search Grounding** | ❌ 无 | ✅ 有 |
| **多图支持** | ✅ 有（最多3张） | ✅ 有（最多14张） |
| **速度** | ~10秒 | ~10秒 |
| **推荐场景** | 生产环境，追求稳定性 | 追求最佳质量，需要高分辨率 |

### Q2: 应该选择哪个模型？

**选择 Nano Banana**（`gemini-2.5-flash-image`）如果：
- ✅ 需要生产环境稳定性
- ✅ 1K 分辨率足够使用
- ✅ 希望成本最低（$0.025/次）

**选择 Nano Banana 2**（`gemini-3-pro-image-preview`）如果：
- ✅ 需要高分辨率（2K/4K）
- ✅ 追求最佳图像质量
...
| 模型 | 老张 API | 官网 | 节省 |
|------|---------|------|------|
| **Nano Banana 2** | $0.05/次 | $0.24/次 | **79%** |
...
<Tip>
💡 **需要帮助？**  
- 📖 [查看图像生成文档](/api-capabilities/gemini-flash-image)
- 💬 加入我们的社区获取支持
- 🔑 [获取你的 API 密钥](https://api.laozhang.ai/token)
</Tip>
