...
description: "Nano Banana (Gemini 2.5 Flash): 高性价比图像生成 API。仅 $0.025/张，10秒极速出图。支持 Base64 输出和 OpenAI 格式。"
icon: "sparkles"
---
...
A: 只需将模型名从 `sora_image` 改为 `gemini-2.5-flash-image`，并修改结果处理逻辑（从 URL 改为 base64）。
