...
description: "Gemini 图像生成 API：基于 Google Gemini 2.5 Flash，10 秒极速出图。仅 $0.025/张，比官方便宜 37.5%。Base64 返回，OpenAI 兼容格式。"
icon: "sparkles"
---
...
**推荐迁移到正式版**:
- ✅ 新版本：[Gemini 2.5 Flash Image](/api-capabilities/gemini-flash-image)（正式版，更稳定）
- 🎁 新功能：支持自定义纵横比（16:9、9:16 等 10 种比例）
- 💰 价格不变：仍为 $0.025/张
- 🔄 迁移简单：只需更新模型名称即可

[查看新版文档 →](/api-capabilities/gemini-flash-image)
</Warning>
