...
老张API 全面支持 OpenAI 最新的 Responses API，这是 2025年3月推出的新一代智能体构建接口。Responses API 结合了 Chat Completions 的简洁性与 Assistants API 的工具使用和状态管理能力，为开发者提供更灵活、更强大的AI应用构建体验。
...
<Info>
  **开发建议**：新项目推荐直接使用 Responses API，现有项目可以逐步迁移。老张API 将持续跟进 OpenAI 的更新，确保功能完整性。
</Info>

---

需要更多帮助？请访问 [老张API官网](https://api.laozhang.ai) 或查看 [OpenAI Responses API 官方文档](https://platform.openai.com/docs/api-reference/responses)。