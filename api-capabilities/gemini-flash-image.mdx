...
<Accordion title="示例 1：文生图（Text-to-Image）">
...
ASPECT_RATIO = "16:9"
IMAGE_SIZE = "4K"  # Nano Banana 2 支持: 1K, 2K, 4K
...
<Accordion title="示例 2：单图生图（Image-to-Image）">
...
INPUT_IMAGE = "cat.jpg"  # 准备一张图片
PROMPT = "Transform this into Van Gogh Starry Night style"
ASPECT_RATIO = "1:1"
...
<Accordion title="示例 3：多图混合（Multi-Image）">
...
# 准备多张图片（支持最多 14 张）
IMAGES = ["cat.jpg", "apple.jpg"]
PROMPT = "Combine these: a cat eating an apple on a table"
ASPECT_RATIO = "16:9"
IMAGE_SIZE = "2K"  # Nano Banana 2: 1K, 2K, 4K
# ============================
