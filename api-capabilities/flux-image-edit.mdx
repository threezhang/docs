...
<Tip>
💡 **节省成本**：通过 老张API 调用 Flux 图像编辑，结合汇率优势和充值加赠，比官方价格节省超过 12.5%！
</Tip>
...
- [蒙版制作教程](https://docs.laozhang.ai/tutorials/mask-creation) - 详细制作指南
- [在线蒙版工具](https://mask.laozhang.ai) - 在线制作蒙版
